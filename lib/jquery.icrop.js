...
Icrop.prototype._zoom = function(zoom) {
    var o = this.options,
        width, height,
        left, top;
...
Icrop.prototype._triggerDebounced = debounce(Icrop.prototype._trigger, 300);
